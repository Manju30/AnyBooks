...
public partial class horrorcart : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                if (Session["Buyitems"] == null)
                {
                    ...
                    String myquery = "select * from Horrorcart where productid=" + Request.QueryString["id"];
                    ...
                    Response.Redirect("horrorcart.aspx");
                }
                else
                {
